...
public class BlockType {
    ...
    public static final int PISTON_MOVING = 36;
    ...
    public static final int REDSTONE_REPEATER_ON = 93;
    public static final int REDSTONE_REPEATER_OFF = 94;
    public static final int LOCKED_CHEST = 95;
    public static final int TRAPDOOR = 96;
    public static final int SILVERFISH_STONE = 97;
    public static final int STONE_BRICK = 98;
    public static final int HUGE_RED_MUSHROOM = 99;
    public static final int HUGE_BROWN_MUSHROOM = 100;
    ...
    public static final int LILLY_PAD = 111;
    ...
    public static final int DOUBLE_WOOD_SLAB = 125;
    public static final int WOOD_SLAB = 126;
    ...
    public static final int BEACON_BLOCK = 138;
    ...
    public static final int HEADS = 144;
    ...
    public static final int REDSTONE_COMPARATOR_INACTIVE = 149;
    public static final int REDSTONE_COMPARATOR_ACTIVE = 150;
